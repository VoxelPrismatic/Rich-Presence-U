...
// EnUS is the en_US translation table.
var EnUS = map[string]string{
	...
	"IGDB_TEST":               "Test connection",
	"IGDB_TEST_OK":            "Connected to IGDB.",
	...
	"INSTALL_HINT":            "Add a launcher to your application menu? This copies the app into ~/.config/rich-presence-u and downloads the icon and desktop entry from GitHub.",
	...
	"PRESERVE_TIME_HINT":      "Your elapsed time will not be reset when changing games.",
	...
	"CLOCK_COUNT_UP":          "Counting up. Click to count down.",
	"CLOCK_COUNT_DOWN":        "Counting down. Click to count up.",
	"CLOCK_RESET":             "Reset",
	"TIMER_HOURS":             "Hours",
